...
var members: [String: Member] = [
    "jonghyuck": Member(id: 1, name: "jonghyuck", phoneNumber: "1", borrowedBooks: ["book1"]),
    "juyeon_k": Member(id: 2, name: "juyeon_k", phoneNumber: "2", borrowedBooks: []),
    "juyeon_j": Member(id: 3, name: "juyeon_j", phoneNumber: "3", borrowedBooks: []),
    "seojin": Member(id: 4, name: "seojin", phoneNumber: "4", borrowedBooks: []),
    "eunseo": Member(id: 5, name: "eunseo", phoneNumber: "5", borrowedBooks: []),
]
